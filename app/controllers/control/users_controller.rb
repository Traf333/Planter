...
module Control
  class UsersController < ControlPanelController
    ...
    def create
      ...
      respond_to do |format|
        if @user.save
          format.html { redirect_to control_users_path,
                                    notice: t('activerecord.attributes.user.messages.has_been_success_created') }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to control_users_url }
        format.json { head :no_content }
      end
    end
  end
